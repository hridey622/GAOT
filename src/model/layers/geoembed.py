...
if __name__ == "__main__":
    ...
    spatial_nbrs = {"neighbors_index": torch.randint(0, 10, (20,)), "neighbors_row_splits": torch.tensor([0, 5, 10, 20])}
    geo_embed = GeometricEmbedding(3, 64, method='pointnet')
    output = geo_embed(input_geom, latent_queries, spatial_nbrs)
    print(output.shape)